...
const de: Catalog = {
  ...
  prTitle: "PR Review",
  prRepoHdr: "REPO",
  prListHdr: "OFFENE PRs",
  prNoPrs: "keine offenen PRs",
  prLoading: "lade PRs …",
  prPickTag: "Repo + PR",
  prAnalyzeVerb: "analysieren",
  prAnalyzing: "analysiere auf",
  prRisk: "Risiko",
  prMergeLabel: "Mergeability",
  prFindings: "Findings",
  prApprove: "approve",
  prComment: "kommentieren",
  prRequestChanges: "Änderungen anfordern",
  prMergeVerb: "mergen",
  prStartSession: "Session starten",
  prActionInputHdr: "Kommentar (optional) — ⏎ senden",
  prCommenting: "sende Review via gh …",
  prMerging: "merge via gh …",
  prLaunching: "starte Session …",
  prReviewed: "Review gepostet",
  prMerged: "PR gemergt",
  prErr: "Aktion fehlgeschlagen",
  prRetry: "erneut",
  // theme picker
  themeTitle: "Theme",
...
const en: Catalog = {
  ...
  prListHdr: "OPEN PRs",
  prNoPrs: "no open PRs",
  prLoading: "loading PRs …",
  prPickTag: "repo + PR",
  prAnalyzeVerb: "analyze",
  prAnalyzing: "analyzing on",
  prRisk: "risk",
  prMergeLabel: "mergeability",
  prFindings: "findings",
  prApprove: "approve",
  ...
  prMergeVerb: "merge",
  prStartSession: "start session",
  prActionInputHdr: "comment (optional) — ⏎ to send",
  prCommenting: "posting review via gh …",
  prMerging: "merging via gh …",
  prLaunching: "starting session …",
  prReviewed: "review posted",
  prMerged: "PR merged",
  prErr: "action failed",
  prRetry: "retry",
  // theme picker
