...
function renderGrid(
  ...
  out.push("");
  out.push(
    `${fg(46)}◆ ${stateLabel("aktiv")}${RESET} ${DIM}·${RESET} ${fg(39)}◑ ${stateLabel("monitor")}${RESET} ${DIM}·${RESET} ${fg(220)}◐ ${stateLabel("wartet")}${RESET} ${DIM}·${RESET} ${fg(245)}○ ${stateLabel("stale")}${RESET}`,
  );
  out.push(
    qFocus
